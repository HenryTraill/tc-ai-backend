...
export const StudentCard = ({ student }: { student: Student }) => (
  <Link
    ...
    className="bg-white border border-black rounded-2xl hover:shadow-xl hover:border-sky-blue transition-all duration-300 p-5 block group hover:-translate-y-1"
  >
